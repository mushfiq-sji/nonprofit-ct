...
const EDGE_FUNCTIONS: EdgeFunction[] = [
  ...
  { name: "action-item-tracker", category: "AI", description: "Board action scan — overdue & blocked", required: false, envVars: ["OPENAI_API_KEY"] },
...
export default function DeploymentStatus() {
  ...
  const testFunction = async (functionName: string) => {
    ...
    const testPayloads: Record<string, object> = {
      ...
      'meeting-summarizer': { transcript: 'health check', log_run: false },
      'action-item-tracker': { ping: true },
