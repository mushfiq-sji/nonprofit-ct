...
const TEST_ACCOUNTS = [
  { label: "Executive Director", email: "ceo@collabai.software", role: "executive_director", icon: Building2, color: "border-blue-500/30 hover:bg-blue-500/10" },
  { label: "Development Director", email: "demo@collabai.software", role: "development_director", icon: FolderKanban, color: "border-green-500/30 hover:bg-green-500/10" },
  { label: "Finance Manager", email: "finance@collabai.software", role: "finance_manager", icon: DollarSign, color: "border-amber-500/30 hover:bg-amber-500/10" },
  { label: "Operations Manager", email: "ic@collabai.software", role: "operations_manager", icon: Settings, color: "border-teal-500/30 hover:bg-teal-500/10" },
] as const;
